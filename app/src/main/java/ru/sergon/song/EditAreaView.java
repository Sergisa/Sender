...
public class EditAreaView extends WebView implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    public EditAreaView(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            Log.e("EditorDebug",e.getMessage());
            Toast.makeText(getContext(), "Unknown exception while reading",Toast.LENGTH_LONG).show();
            return;
        }
        Log.d("EditorDebug",html);
        if (!isDark)
    ...
    private class EditorViewChromeClient extends WebChromeClient {
        ...
        public boolean onConsoleMessage(ConsoleMessage consoleMessage) {
            Log.d("EditorDebug", consoleMessage.message() +
    ...
    public void execCommand(final EditorCommand ec) {
        ...
        try {
            ...
            Toast.makeText(getContext(), "outofMemory",Toast.LENGTH_LONG).show();
        }
    }
    ...
    public String getText(){
        ...
        execCommand(new EditorCommand.Builder("getText").callback(new JsCallback<String>() {
            @Override
            public void onCallback(String data) {
                Log.d("EditorDebug","callback: "+data);
                sb.append(data);
